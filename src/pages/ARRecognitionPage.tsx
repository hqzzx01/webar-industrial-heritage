...
import { HeritageOverviewModel } from '../components/HeritageOverviewModel';
...
export function ARRecognitionPage() {
  ...
  return (
    <section className="camera-page recognition-page">
      <ARCameraView showReticle={false} label="白模识别成功，可点击点位标签">
        ...
        />
        <HeritageOverviewModel points={externalPoints} onVisit={visitPoint} />
